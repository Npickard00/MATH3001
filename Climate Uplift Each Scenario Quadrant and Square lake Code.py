# -*- coding: utf-8 -*-
"""
Created on Mon Apr  7 23:51:41 2025
...
def get_flow_uplift(year, scenario, selected_file):
    """
    Returns flow uplift percentage (c), error estimate, and river height uplift (hu)
...
height=Data['Height']+heightuplift
...
# Optional: Add label
ax.text(peak_time + 0.08, ((uplifted_peak_flow + baseline_peak_flow)/ 2)-0.07, 
        'Flow\nUplift', color='red', fontsize=12)
